...
public class StocksMediator implements Mediator {
    ...
    public void saleOffer(String stock, int shares, int collCode) {
        ...
        for (StockOffer offer : stockBuyOffers) {
            if ((offer.getStockSymbol() == stock) && (offer.getstockShares() == shares)) {
                System.out.println(shares + " shares of " + stock + " sold to colleague code " + collCode);
    ...
    public void buyOffer(String stock, int shares, int collCode) {
        ...
        for (StockOffer offer : stockSaleOffers) {
            if ((offer.getStockSymbol() == stock) && (offer.getstockShares() == shares)) {
                System.out.println(shares + " shares of " + stock + " bought by colleague code " + collCode);
